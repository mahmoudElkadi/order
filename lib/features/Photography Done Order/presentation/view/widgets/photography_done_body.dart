...
import '../manger/photography_done_state.dart';

class PhotographyDoneOrderBody extends StatelessWidget {
  const PhotographyDoneOrderBody({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<PhotographyDoneCubit, PhotographyDoneState>(
