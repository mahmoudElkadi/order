...
import '../manger/photography_received_state.dart';

class PhotographyReceivedOrderBody extends StatelessWidget {
  const PhotographyReceivedOrderBody({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<PhotographyReceivedCubit, PhotographyReceivedState>(
